...
/**
 * Color.kt - Ekstra farger som ikke er en del av standard Material 3 ColorScheme.
 * 
...
/**
 * Statusfarger for HomeScreen.
 * Grønn = aktiv, Rød = pausert.
 */
val StatusActive = Color(0xFF4CAF50)
val StatusPaused = Color(0xFFEF5350)

/**
 * Ekstra statusfarger for bruk i diverse UI-komponenter.
 * Grønn = suksess, Gul = advarsel, Rød = feil.
 */
